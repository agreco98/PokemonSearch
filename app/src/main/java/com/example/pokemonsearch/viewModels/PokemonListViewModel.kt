...
class PokemonListViewModel @Inject constructor(
    ...
    var pokemonList = mutableStateOf<List<PokemonSearchListEntry>>(listOf())
    var loadError = mutableStateOf("")
    var isLoading = mutableStateOf(false)
    var endReached = mutableStateOf(false)

    private var cachedPokemonList = listOf<PokemonSearchListEntry>()
        ...
        viewModelScope.launch {
            ...
            when(result) {
                is Resource.Success -> {
                    ...
                    val pokemonSearchEntries = result.data.results.mapIndexed { index, entry ->
